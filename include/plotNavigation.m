...
%% Plot all figures =======================================================
    ...
    figure('Name','Position Solution of EKF and WLS')
    % geobasemap satellite; hold on;
    plot(navSolutions.longitude,navSolutions.latitude,'.');
    hold on;
    plot(navSolutions.longitude_ekf,navSolutions.latitude_ekf,'*');
    hold on;
    plot(mean(navSolutions.longitude),mean(navSolutions.latitude),'.');
    hold on;
    plot(mean(navSolutions.longitude_ekf),mean(navSolutions.latitude_ekf),'*');
    hold on;
    xlabel('Longitude (°E)'); ylabel('Altitude (°N)');
    legend('WLS','EKF','mean WLS','mean EKF');
    title('Positions obtained from WLS and EKF','FontWeight','bold');
